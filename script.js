...
const ITEM_TYPES = [
  ...
  {abbr:'LMP',name:'Lamp',category:'Lighting',color:0xf0d56b,tags:['Warm','Simple','Clean'],points:10},
  ...
  {abbr:'PLT',name:'Plant',category:'Natural',color:0x5da35d,tags:['Natural','Light'],points:16},
